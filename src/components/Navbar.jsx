  ...
  return (
    <div className="fixed w-full h-[80px] font-bold px-8 flex justify-between items-center">
      ...
      <ul className="hidden md:flex text-2xl">
        ...
        <Link to="comment" smooth={true} duration={500}>
          <li className="mx-2 hover:border-[#182848] hover:bg-[#182848] hover:text-white duration-150">
            Comment
          </li>
        </Link>
      ...
      >
        <Link onClick={onhandleClick} to="home" smooth={true} duration={500}>
          <li className="my-4 text-3xl">Home</li>
        </Link>
        <Link onClick={onhandleClick} to="skills" smooth={true} duration={500}>
          <li className="my-4 text-3xl">Skills</li>
        </Link>
        <Link onClick={onhandleClick} to="work" smooth={true} duration={500}>
          <li className="my-4 text-3xl">Work</li>
        </Link>
        <Link onClick={onhandleClick} to="comment" smooth={true} duration={500}>
          <li className="my-4 text-3xl">Comment</li>
        </Link>
        <li className="w-[260px] flex justify-between items-center mt-8 text-3xl cursor-auto">
      ...
      {/* Contact */}
      <div className="hidden md:flex fixed left-0 bottom-[5%] flex-col ">
        <ul>
          ...
          <li className="w-[180px] h-[50px] rounded-tl-none rounded-bl-none text-2xl flex text-white bg-[#182848] ml-[-120px] hover:ml-[-10px] duration-500 mt-2">
            <button
              onClick={() => console.log('main-email')}
              className="w-full flex justify-between items-center"
            >
              Email <HiOutlineMail />
            </button>
          </li>
          <li className="w-[220px] h-[50px] rounded-tl-none rounded-bl-none text-2xl flex text-white bg-[#182848] ml-[-160px] hover:ml-[-10px] duration-500 mt-2">
            <button
              onClick={() => console.log('main-kakao')}
              className="w-full flex justify-between items-center"
            >
